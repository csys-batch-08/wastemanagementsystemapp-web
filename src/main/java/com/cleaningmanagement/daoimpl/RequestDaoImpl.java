	...
	public List<Request> showRequest() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				request = new Request(resultSet.getInt(1), user, employee, resultSet.getString(4),
						resultSet.getString(5), resultSet.getString(6), resultSet.getDate(7), resultSet.getString(8),
